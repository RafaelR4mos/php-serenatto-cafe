...
$produto = $produtoRepositorio->buscarProduto($idProduto);

if (isset($_POST['editEnviado'])) {
  $produto = new Produto(
    $idProduto,
    $_POST['tipo'],
    $_POST['nome'],
  ...
  if ($_FILES['imagem']['error'] == 'UPLOAD_ERR_OK') {
    ...
    move_uploaded_file($_FILES['imagem']['tmp_name'], $produto->getImagemFormatado());
  }
  ...
  <main>
    ...
    <section class="container-form">
      <form method="POST" enctype="multipart/form-data">
        ...
        <input type="submit" name="editEnviado" class="botao-cadastrar" value="Editar produto" />
      </form>
